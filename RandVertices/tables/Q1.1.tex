...
\hhline{|--|~}
	...
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 {\gnumericPB{\raggedright}\gnumbox[l]{Parametric and normal form of $AB$}}
\\
\hhline{|--|~}
	\multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|--|~}
	...
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 {\gnumericPB{\raggedright}\gnumbox[l]{Parametric and normal form of $BC$}}
\\
\hhline{|--|}
	\multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|--|~}
	...
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 {\gnumericPB{\raggedright}\gnumbox[l]{Parametric and normal form of $CA$}}
\\
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|---|}
	...
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 {\gnumericPB{\raggedright}\gnumbox[l]{ $\vec{A}, \vec{B}$ and $\vec{C}$ are non collinear}}
\\
\hhline{|---|}
	\multicolumn{1}{|p{\gnumericColA}|}%
	...
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 {\gnumericPB{\raggedright}\gnumbox[l]{Area of Triangle $\triangle ABC$}}
\\
\hhline{|---|}
	\multicolumn{1}{|p{\gnumericColA}|}%
