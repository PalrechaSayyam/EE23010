...
\begin{align}
	...
	&= \frac{n}{4}
\end{align}
Using the normal-distribution of $Y$,
\begin{align}
...
\begin{align}
	\pr{Y>0} &= 1 - \pr{Y = 0}\\
	&= 1 - f_Y(0)\\
	&= 1 - \frac{1}{\sigma\sqrt{2\pi}}e^{-\frac{(0-\mu)^2}{2\sigma^2}}\\
	&= 1 - \frac{2}{\sqrt{2\pi n}}e^{-\frac{n}{2}}
\end{align}
\begin{align}
	\pr{Y>0} &> 0.9\\
	1 - \frac{2}{\sqrt{2\pi n}}e^{-\frac{n}{2}} &> 0.9\\
	\sqrt{\frac{2}{\pi n}}e^{-\frac{n}{2}} &< 0.1\\
	\frac{2}{\pi n}e^{-n} &< 0.01\\
	e^{-n} &< 0.005\pi n\\
	-n &< \ln{0.0157} + \ln{n}\\
	n + \ln{n} &> 4.15\\
	\implies n &= 4
