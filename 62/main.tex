...
\begin{align}
	...
	&= \frac{1}{2\sqrt{3}}\int^{\sqrt{3}}_{-\sqrt{3}}xdx\\
	&= 0 \label{eq:gate62}
\end{align}
The variance of $X$ is:
\begin{align}
	\sigma_X^2 &= \int^{-\infty}_{\infty}\brak{x-\mu_X}^2f(x)dx
\end{align}
From \eqref{eq:gate62}
\begin{align}
	\sigma_X^2 &= \frac{1}{2\sqrt{3}}\int^{\sqrt{3}}_{-\sqrt{3}}x^2dx\\
	&= \frac{1}{2\sqrt{3}}\brak{\frac{6\sqrt{3}}{3}}\\
	&= 1
\end{align}
%\newpage
\begin{figure}
\includegraphics[width=\columnwidth]{./figs/main.png}
\caption{Theoretical vs Simulated variance}
\label{fig:theo_Var(X)}
\end{figure}
\end{document}
