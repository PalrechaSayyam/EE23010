...
\begin{align}
	...
	&= \pr{A}\pr{B^\prime}\pr{ C^\prime} + \pr{B}\pr{C^\prime}\pr{ A^\prime} + \pr{C}\pr{A^\prime }\pr{B^\prime}\\
	&= 3p(1-p)^2\\
	\pr{X=2} &= \pr{A\cdot B\cdot C^\prime} + \pr{B\cdot C\cdot A^\prime} + \pr{C \cdot A\cdot B^\prime}\\
	&= \pr{A}\pr{B}\pr{C^\prime}+\pr{B}\pr{C}\pr{A^\prime}+\pr{C}\pr{A}\pr{B^\prime}\\
	&= 3p^2(1-p)\\
	\pr{X=3} &= \pr{ABC}\\
	&= \pr{A}\pr{B}\pr{C}\\
	&= p^3
