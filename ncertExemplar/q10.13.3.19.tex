...
\begin{align}
	...
	\intertext{defined for all the values of $-5 \leq k\leq 5$}
	&= \frac{1}{36}\brak{\frac{d^{|k|}}{dz^{|k|}}\brak{z^{-5}+...+z^{5}}}_{z=0} \label{eq:z-transform eqn}
	\intertext{the above expression extracts the coefficient of $z^k$ for the desired value of $k$ and w.k.t the coefficients of $z^k$ and $z^{-k}$ are the same.}\nonumber
\end{align}
\begin{enumerate}
