...
Prove that
\begin{enumerate}
\item[(i)] $\pr{A} = \pr{AB} + \pr{AB^\prime}$
\item[(ii)]$\pr{A+B} = \pr{AB} + \pr{AB^\prime} + \pr{A^\prime B}$
\end{enumerate}
...
\end{align}
$AB$, $AB^\prime$ and $A^\prime B$ are mutually exclusive as their pairwise product is zero.
\begin{align}
	&= \pr{AB} + \pr{AB^\prime} + \pr{A^\prime B} -\pr{AB(AB^\prime)} -\pr{AB^\prime(A^\prime B)} -\pr{A^\prime B(AB)} + \pr{(AB)(AB^\prime)(A^\prime B)}\\
